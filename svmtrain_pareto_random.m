% Generating 1 hundred thousand samples through random sampling and applying SVM for classification 
...
for i = 1: rand_sample
    nsamples = 22;
    randcontrol_resp(i, 1:nsamples) =  abs(random (pd_control,nsamples,1));
...
for i = 1: rand_sample
    nsamples = 22;
    randolfact_resp(i, 1:nsamples) = abs(random (pd_olfact,nsamples,1));
    randolfact_resp(i,23) = 1;%Label for classification
end
